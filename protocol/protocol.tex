...
\begin{enumerate}
    ...
    \item Apply the caliper by adding a large penalty to distances exceeding the caliper.
...
The following tables present shell structures for the key summary statistics, tables, and visualizations that will be used to report findings from the analyses.
